...
<head>
  ...
  <!-- Favicon icon-->
  <link rel="shortcut icon" type="image/png" href="../assets/images/logos/favicone.png" />
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css">

  <!-- Core Css -->
  <link rel="stylesheet" href="../assets/css/styles.css" />

  <title>Farm Solution</title>
</head>

<body>
  <!-- Preloader -->
  <div class="preloader">
    <img src="../assets/images/logos/favicone.png" alt="loader" class="lds-ripple img-fluid" />
  </div>
        ...
        <div class="row">
          <div class="col-xl-5 col-xxl-4">
            <div class="authentication-login min-vh-100 bg-body row justify-content-center">
              <div class="col-12">
                <a href="{{ url('/otp') }}" class="text-nowrap logo-img d-block px-4 py-9 w-100">
                  <!-- <img src="../assets/images/logos/farm_logo.jpeg" class="dark-logo" alt="Logo-Dark" /> -->
                  <img src="../assets/images/logos/farm_logo.jpeg" style="width:100%;" class="" alt="Logo-light" />
                </a>
              </div>
              <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                <!-- <h2 class="mb-1 fs-7 fw-bolder">Welcome to Farm Data Solution</h2> -->
                <p class="mb-7">OTP Dashboard</p>
                <div class="row">
                </div>
                @if ($errors->any())
                ...
                @endif
                <form method="POST" action="{{ url('otpuser.verify') }}">
                    @csrf
                  <div class="mb-4">
                    <label for="exampleInputPassword1" class="form-label">Enter the Code below and Save</label>
                    <input type="text" name="otpservarify" class="form-control" id="exampleInputPassword1" placeholder="Code on App here....">
                  </div>
                  <div class="d-flex align-items-center justify-content-between mb-4">
                    <p class="text-primary fw-medium fs-3" href="../main/authentication-forgot-password.html">Not Remember then Contact to Admin</p>
                  </div>
