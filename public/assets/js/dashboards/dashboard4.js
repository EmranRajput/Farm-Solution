...
$(function () {
    ...
    var options = {
        ...
        labels: percentageArray[1, 0].toFixed(1),
        chart: {
            type: "donut",
            height: 140,
            fontFamily: "inherit",
                ...
                donut: {
                    ...
                    labels: {
                        ...
                        total: {
                            ...
                            fontSize: '16px',
                            fontWeight: "500",
                            label: percentageArray[1].toFixed(1) + '%',
                        },
                    },
                },
            },
...
var chart_column_basic; 
function renderChart(monthlyCosts) {
    if (chart_column_basic) {
        chart_column_basic.updateSeries([
            {
                name: "",
                data: monthlyCosts, // Replace the existing data with the new monthlyCosts
            },
        ]);
    } else {
        var option_page_views = {
        ...
        chart_column_basic = new ApexCharts(
            document.querySelector("#page_views"),
            option_page_views
        );
